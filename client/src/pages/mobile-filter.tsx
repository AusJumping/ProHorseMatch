...
export default function MobileFilterPage() {
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      {/* Header */}
      <div className="sticky top-0 left-0 right-0 bg-white border-b border-neutral-200 z-10">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="filter-section">
          <Label className="block font-accent font-semibold mb-2 text-neutral-800">Discipline</Label>
          <Select 
        ...
        <div className="filter-section">
          ...
          <div className="flex gap-2">
            <div className="w-1/2">
              <Select
                value={filters.price_min !== null ? String(filters.price_min) : "0"}
                onValueChange={(value) => handleChangeFilter('price_min', parseInt(value))}
              >
                <SelectTrigger className="w-full bg-neutral-100 border border-neutral-200 rounded-lg">
                  <SelectValue placeholder="No Min">No Min</SelectValue>
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="w-1/2">
              <Select
                value={filters.price_max !== null ? String(filters.price_max) : "999999999"}
                onValueChange={(value) => handleChangeFilter('price_max', parseInt(value))}
              >
                <SelectTrigger className="w-full bg-neutral-100 border border-neutral-200 rounded-lg">
                  <SelectValue placeholder="No Max">No Max</SelectValue>
                </SelectTrigger>
                <SelectContent>
        ...
        <div className="filter-section">
          ...
          <div className="flex gap-2">
            <div className="w-1/2">
              <Select
                value={filters.age_min !== null ? String(filters.age_min) : "0"}
            ...
            <div className="w-1/2">
              <Select
                value={filters.age_max !== null ? String(filters.age_max) : "999"}
        ...
        <div className="filter-section">
          ...
          <div className="flex gap-2">
            <div className="w-1/2">
              <Select
                value={filters.height_min !== null ? String(filters.height_min) : "0"}
            ...
            <div className="w-1/2">
              <Select
                value={filters.height_max !== null ? String(filters.height_max) : "999"}
        ...
        <div className="filter-section">
          ...
          >
            <SelectTrigger className="w-full bg-neutral-100 border border-neutral-200 rounded-lg">
              <SelectValue placeholder="Any Location">Any Location</SelectValue>
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="filter-section">
          ...
          >
            <SelectTrigger className="w-full bg-neutral-100 border border-neutral-200 rounded-lg">
              <SelectValue placeholder="All Breeds">All Breeds</SelectValue>
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="filter-section">
          ...
          >
            <SelectTrigger className="w-full bg-neutral-100 border border-neutral-200 rounded-lg">
              <SelectValue placeholder="Any Sex">Any Sex</SelectValue>
            </SelectTrigger>
            <SelectContent>
